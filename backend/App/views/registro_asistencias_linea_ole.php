...
<script>
    ...
    $(document).ready(function() {
        ...
        let codigo = '';
        var link_a = $(location).attr('href');
        var clave_a = link_a.substr(link_a.indexOf('Ole/')+4,link_a.length);
        ...
        $("#codigo_registro").on('change',function(){
            ...
            $.ajax({
                url: "/RegistroLinea/registroAsistenciaOLE/"+codigo+'/'+clave_a,
                type: "POST",
                // data: formData,
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta.status == 'success') {
                        ...
                        Swal.fire({
                            title: '¡Lo sentimos, esta persona no pertenece a la Línea Ole!',
                            // html: 'I will close in <b></b> milliseconds.',
                            icon: 'warning',
                            timer: 1000,
                            // timerProgressBar: true,
